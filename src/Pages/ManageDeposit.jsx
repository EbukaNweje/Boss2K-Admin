...
const ManageDeposit = () => {
    ...
    const acceptDeposit = (depositId) => {
        const url = `https://coinstarpro-bitminers-new-backnd-three.vercel.app/api/confirm-deposit/${depositId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://coinstarpro-bitminers-new-backnd-three.vercel.app/api/alldeposit";
        axios.get(url)
            .then((response) => {
